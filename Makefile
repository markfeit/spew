...
# $XFree86: mit/config/Imake.tmpl,v 2.11 1994/05/02 11:40:57 dawes Exp $
...
# $XFree86: mit/config/site.def,v 2.43 1994/04/16 04:20:51 dawes Exp $
...
# $XFree86: mit/config/xf86_vers.def,v 2.14 1994/05/04 10:40:23 dawes Exp $

# -------------------------------------------------------------------------
# XFree86 version: 2110
# -------------------------------------------------------------------------

# $XFree86: mit/config/lnuxLib.rules,v 2.9 1994/03/17 12:48:22 dawes Exp $
...
install:: spew
	...
	$(INSTALL) -c $(INSTPGMFLAGS)  spew $(DESTDIR)$(BINDIR)

install.man:: spew.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(INSTALL) -c $(INSTMANFLAGS) spew.man $(DESTDIR)$(MANDIR)/spew.$(MANSUFFIX)
